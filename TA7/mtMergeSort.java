...
public class mtMergeSort {
    ...
    private static class SortThreads extends Thread {
        SortThreads(Integer[] array, int begin, int end) {
            super(() -> {
                mtMergeSort.mergeSort(array, begin, end);
            });
            this.start();
        }
    }
    ...
    public static void main(String[] args) {
        mtMergeSort mt = new mtMergeSort();
        Integer[] arr = new Integer[10000000];
        Integer[] arr_copy = new Integer[10000000];
        ...
        mtMergeSort.threadedSort(arr);

        long s = System.currentTimeMillis();
        mtMergeSort.mergeSort(arr_copy, 0, 9999999);
        long total = System.currentTimeMillis() - s;
        System.out.println("Regular merge sort took: " + total + "ms");
    }
}
